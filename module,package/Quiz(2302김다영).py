# 1. 핸드폰 요금이 62421원 나왔다. 100원 미만은 절사한다고 한다. 62400원 청구. 59827원일 경우, 실제
# 청구 금액은?
import math
bill = 59827
print(round(bill,-2))
...
print(now)
birthday = datetime.datetime(2004,3,4,17,30)
dbirthday = datetime.datetime(1971,9,27)
mbirthday = datetime.datetime(1975,3,30)
print(now-dbirthday)
print(now-mbirthday)
print(now-birthday)
...
import datetime
now = datetime.datetime.now()
chirstmas = datetime.datetime(2021,12,25,00,00)
print(chirstmas-now)
# 7. 내 생일이 며칠 남았는지?
import datetime
now = datetime.datetime.now()
birthday = datetime.datetime(2022,3,4,0,0)
print(birthday-now)
yjbirthday = datetime.datetime(2021,9,23,0,0)
